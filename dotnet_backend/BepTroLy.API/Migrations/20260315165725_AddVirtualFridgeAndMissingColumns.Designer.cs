...
namespace BepTroLy.API.Migrations
{
    ...
    [Migration("20260315165725_AddVirtualFridgeAndMissingColumns")]
    partial class AddVirtualFridgeAndMissingColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BepTroLy.API.Models.Feedback", b =>
                {
            ...
            modelBuilder.Entity("BepTroLy.API.Models.VirtualFridge", b =>
                {
                    b.Property<int>("FridgeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BepTroLy.API.Models.FridgeMember", b =>
                {
                    b.HasOne("BepTroLy.API.Models.VirtualFridge", "Fridge")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("BepTroLy.API.Models.PantryItem", b =>
                {
                    ...
                    b.HasOne("BepTroLy.API.Models.VirtualFridge", "VirtualFridge")
                        .WithMany("PantryItems")
                        .HasForeignKey("FridgeId")
